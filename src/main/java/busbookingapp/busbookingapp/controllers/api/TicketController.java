package busbookingapp.busbookingapp.controllers.api;
...
import busbookingapp.busbookingapp.Response;
import busbookingapp.busbookingapp.entity.Ticket;
import busbookingapp.busbookingapp.entity.UserTicket;
import busbookingapp.busbookingapp.repository.TicketRepository;
import busbookingapp.busbookingapp.repository.UserTicketRepository;
...
public class TicketController {
  ...
  // QUERY
  // http://localhost:8080/api/create-ticket?ticketnumber=123&busId=123&paymentMethod=netbanking&amount=2500&passengerEmail=r.rahul.developer@gmail.com&passengerMobileNumber=8002030975
  ...
  // QUERY
  // http://localhost:8080/api/add-user?ticketnumber=12390&name=dusklight&age=19&gender=male&preference=upper&className=UP&price=2000&seatNumber=SUB1
  @GetMapping("/add-user")
  ...
  // QUERY
  // http://localhost:8080/api/get-user-ticket?ticketnumber=123
  ...
  // QUERY
  // http://localhost:8080/api/get-ticket?ticketnumber=123
